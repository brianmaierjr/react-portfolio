			...
			<main>
				<Section label='Work'>
					...
					<p>
						...
						components and a design system that allows our engineers
						to easily build apps, and marketing websites.
					</p>
				</Section>
				<Section label='Now'>
					<h2>Now</h2>
					<ul className='list'>
						...
						<li>
							Building out the Clover Learning Design System aka
							Bones
						</li>
						<li>
							Dabbling with React Native to get ready for our
							future mobile app
						</li>
						<li>
							Converting Long Haul Jekyll Theme to Astro - Very
							close!
						</li>
